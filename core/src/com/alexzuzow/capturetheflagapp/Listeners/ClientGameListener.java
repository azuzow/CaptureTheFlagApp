    ...
    public void received(Connection c, Object o) {
        ...
        if (o instanceof BufferPlayerUpdate) {
            ...
            if (CaptureTheFlagApp.playerList.containsKey(updatePlayer.clientID)) {
                ...
                CaptureTheFlagApp.playerList.get(updatePlayer.clientID).setRedTeam(updatePlayer.isRedTeam);
                CaptureTheFlagApp.playerList.get(updatePlayer.clientID).setBlueTeam(updatePlayer.isBlueTeam);
