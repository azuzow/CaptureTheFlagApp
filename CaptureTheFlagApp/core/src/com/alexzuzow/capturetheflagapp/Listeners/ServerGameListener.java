    ...
    public void received(Connection c, Object o) {
        ...
        if (o instanceof BufferPlayerConnect) {
            ...
            for (HashMap.Entry<Integer, BufferAddNewUser> entry : server.getUserList().entrySet()) {
                ...
                newPlayer.playerCategoryBit = entry.getValue().playerCategoryBit;
                newPlayer.carrierCategoryBit = entry.getValue().carrierCategoryBit;
        ...
        if (o instanceof BufferPlayerUpdate) {
            ...
            updateServer.playerCategoryBit = updatePlayer.playerCategoryBit;
            updateServer.carrierCategoryBit = updatePlayer.carrierCategoryBit;
